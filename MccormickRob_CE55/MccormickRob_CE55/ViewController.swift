...
class ViewController: UIViewController {
   ...
   //action begins game, setting play button as false,chooses format
    @IBAction func playGame(_ sender: UIButton) {
        timer = Timer(timeInterval: 1.0, target: self, selector: #selector(setter: ViewController.amount), userInfo: nil, repeats: true)
    ...
    func arrange(){
        if UIDevice.current.userInterfaceIdiom == .phone
        {
            ...
            {
                view.image = #imageLiteral(resourceName: "Brain")
            }
        }
        ...
        if UIDevice.current.userInterfaceIdiom == .phone
        {
            if pairsAmount < 10{
                if pairs[0].image == pairs[1].image
                {
                    ...
                    iphoneView[containsTag1].backgroundColor = UIColor(red: 65/255, green: 210/255, blue: 96/255, alpha: 1)
                    ...
                    iphoneView[containsTag2].backgroundColor = UIColor(red: 65/255, green: 210/255, blue: 96/255, alpha: 1)
                }
                else
                {
                    iphoneView[containsTag1].image = #imageLiteral(resourceName: "Brain")
                    iphoneView[containsTag2].image = #imageLiteral(resourceName: "Brain")
                }
                pairs.removeAll()
                if pairsAmount == 10{
                    timer.invalidate()
            ...
            if pairsAmount < 15{
                if pairs[0].image == pairs[1].image
                {
                    pairsAmount += 1
                     ...
                     ipadContForView[containsTag1].backgroundColor = UIColor(red: 220/255, green: 65/255, blue: 76/255, alpha: 1)
                     ipadContForView[containsTag2].image = nil
                     ipadContForView[containsTag2].backgroundColor = UIColor(red: 220/255, green: 65/255, blue: 76/255, alpha: 1)
                ...
                {
                     ipadContForView[containsTag1].image = #imageLiteral(resourceName: "Brain")
                     ipadContForView[containsTag2].image = #imageLiteral(resourceName: "Brain")
                }
                pairs.removeAll()
    ...
    @objc func ipadFlash() {
        ...
        for v1 in  ipadContForView
        {
            ...
            v1.image = #imageLiteral(resourceName: "Brain")
        }
    }
